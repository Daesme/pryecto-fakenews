...
export class NoticiasComponent implements OnInit {
  ...
  async adicionarNoticia() {
    ...
    try {
      const deployedRegistroContract = await this.registroContract.deployed();
      const numUsuarios = await deployedRegistroContract.getUsersCount.call();
      const registroContractTransaction = await deployedRegistroContract.addNoticia.sendTransaction(this.id, this.titulo, this.tema, this.fecha, this.descripcion, this.url,this.account,{ from: this.account });
